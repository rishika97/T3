    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog d1 = new DatePickerDialog(one.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,date1,year,month,day);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog d2 = new DatePickerDialog(one.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,date2,year,month,day);
